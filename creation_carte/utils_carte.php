...
<form method="post" action="utils_carte.php">
    ...
    <tr>
      <td width="5%"><b><font color="#660000">terrains:</font></b></td>
      <td> 
        <input type="radio" name="terrain" value="1.gif" id="plaine">
        <img src="../fond_carte/1.gif" width="34" height="34"><br>Plaine</td>
      <td> 
        <input type="radio" name="terrain" value="2.gif" id="colline">
        <img src="../fond_carte/2.gif" width="34" height="34"><br>Colline</td>
      <td> 
        <input type="radio" name="terrain" value="3.gif" id="montagne">
        <img src="../fond_carte/3.gif" width="34" height="34"><br>Montagne</td>
	  <td> 
        <input type="radio" name="terrain" value="4.gif" id="desert">
        <img src="../fond_carte/4.gif" width="34" height="34"><br>Desert</td>
	  <td> 
        <input type="radio" name="terrain" value="5.gif" id="neige">
        <img src="../fond_carte/5.gif" width="34" height="34"><br>Neige</td>
	  <td> 
        <input type="radio" name="terrain" value="6.gif" id="plaine">
        <img src="../fond_carte/6.gif" width="34" height="34"><br>Marecage</td>
	  <td> 
        <input type="radio" name="terrain" value="7.gif" id="foret">
        <img src="../fond_carte/7.gif" width="34" height="34"><br>Foret</td>
	  <td> 
        <input type="radio" name="terrain" value="8.gif" id="eau">
        <img src="../fond_carte/8.gif" width="34" height="34"><br>Eau</td>
	  <td> 
...
if (isSet($_POST['pnj']) && isset ($_POST['case'])){
	...
	for ($i = 0; $i < count($tabcase); $i++) {
		...
		if(isset($_SESSION['choix_carte'])){
			...
			if($carte == "arene"){ // arene
				// verification si la case est deja occupee ou non
				$sql = "SELECT occupee_carte FROM arene WHERE x_carte='$tabcase_x' AND y_carte='$tabcase_y'";
				...
				if($oc) {
					...
					if ($pnj <= 9) {	
						...
						$sql = "UPDATE arene SET occupee_carte = '1', idPerso_carte='$id_instance', image_carte='$image_pnj' WHERE x_carte='$tabcase_x' AND y_carte='$tabcase_y'";
						$mysqli->query($sql);
					}
					else {
						if($pnj == 10){
						...
						$sql = "UPDATE arene SET occupee_carte='1', image_carte='$image' WHERE x_carte='$tabcase_x' AND y_carte='$tabcase_y'";
						$mysqli->query($sql);
					}
