				...
				if ($pv_perso <= 0) {
					...
					if (nouveau_tour($date, $dla)) {
						...
						while ($t_persos = $res->fetch_assoc()) {
							...
							if ($id_perso_nouveau_tour == $id_perso) {
