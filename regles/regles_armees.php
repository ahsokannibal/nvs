		...
		<div class="container-fluid">
			...
			<div class="row justify-content-center">
				<div class="col-12">
					...
					<div align="center"><h2>Les armées</h2></div>
			...
			<div class="row">
				<div class="col-12">
					<p>Nord versus Sud est un jeu dans lequel deux armées s'opposent : les Nordistes et les Sudistes.<br />
					Ces armées sont dirigées par les officiers supérieurs et sont organisées de manière bien différente. Vous apprendrez à les connaître au fil du temps.</p>
					...
					<p>Le seul désavantage d'entrer dans une compagnie est une légère perte d'autonomie, cependant rien de bien dramatique.</p>
