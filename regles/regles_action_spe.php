...
<ul>
	<li><b>De façon purement RP</b> : un des persos négocie la réddition d'un annemi. Si durant les échanges, l'ennemi accepte la réddition, celui qui a négocié la capture doit alors avertir l'animation, preuves à l'appuie, afin que l'animation valide ou non cette capture. Dans ce cas, le perso capturé n'a aucune perte d'XP/PI, uniquement une perte classique de PC et une ligne spéciale apparaitra dans le CV pour signifier la capture RP. Pour celui ayant effectué la capture, il gagnera 4PC pour sa capture ainsi qu'une ligne spéciale dans son CV pour signifier la capture RP. <b>Le perso qui accepte de se faire capturer doit arrêter toute action (attaques ou soins) hors déplacements jusqu'à ce que l'animation valide ou refuse la capture !</b></li>
