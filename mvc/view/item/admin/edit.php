<?php
$title = "Administration - Editer un objet";
...
<div class="row justify-content-center text-center">
	<div class="col mx-2 rounded bg-light py-3 bg-opacity-75">
		<h2 class='mb-3'>Editer l'objet "<?= $item->nom_objet ?>"</h2>
		<nav>
		...
		<div class="card h-100 shadow">
			<div class='card-header'>
				<h5 class="card-title mt-2">
					...
					Editer l'objet "<?= $item->nom_objet ?>"
				</h5>
			</div>
			<div class="card-body">
				<form method='post' action='?action=update&id=<?= $item->id_objet?>' enctype="multipart/form-data">
					<div class='row'>
						<div class='col-12 col-sm-4 col-md mb-3 me-3 pt-2'>
							...
							<div class='row'>
								<div class='col-12 mb-3'>
									...
									<input class='form-control<?php if(isset($_SESSION['errors']['name'])):?> is-invalid<?php endif ?>' type='text' name='name' id='name' value="<?= $_SESSION['old_input']['name'] ?? $item->nom_objet?>">
								...
								<div class='col-12 mb-3'>
									...
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="category" id="cat1" value='N'<?php if((isset($_SESSION['old_input']['category']) AND $_SESSION['old_input']['category']=='N')OR(!isset($_SESSION['old_input']['category']) AND $item->type_objet=='N')):?> checked<?php endif;?>>
										<label class="form-check-label" for="cat1">
											Consommable
										</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="category" id="cat2" value='E'<?php if((isset($_SESSION['old_input']['category']) AND $_SESSION['old_input']['category']=='E')OR(!isset($_SESSION['old_input']['category']) AND $item->type_objet=='E')):?> checked<?php endif;?>>
										<label class="form-check-label" for="cat2">
											Equipement
										</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="category" id="cat3" value='RP'<?php if((isset($_SESSION['old_input']['category']) AND $_SESSION['old_input']['category']=='RP')OR(!isset($_SESSION['old_input']['category']) AND $item->type_objet=='RP')):?> checked<?php endif;?>>
								...
								<div class='col-12 mb-3'>
									...
									<textarea class='form-control<?php if(isset($_SESSION['errors']['desc'])):?> is-invalid<?php endif ?>' id="desc" name="desc" rows="5" cols="33" placeholder='Petit objet en cuir de fesses de buffle servant au sevrage des carottes. Ne rapporte aucun bonus, MAIS... aucun malus non plus'><?= $_SESSION['old_input']['desc'] ?? $item->description_objet?></textarea>
								...
								<div class='col-12 mb-3'>
									<label class='fw-semibold form-label<?php if(isset($_SESSION['errors']['unitType'])):?> fw-bold text-danger <?php endif ?>' for='name'>Type(s) d'unité autorisé(s) : </label><br>
								
								<?php if(isset($unitTypes) && !empty($unitTypes)): ?>
									<div class='d-flex flex-row flex-wrap'>
									<?php foreach($unitTypes as $type): ?>
									<div class="form-check form-check-inline mb-2">
										<input class="form-check-input" type="checkbox" name="unitType[]" id='unit<?= $type->id_unite ?>' value='<?= $type->id_unite ?>'<?php if((isset($_SESSION['old_input']['unitType']) AND is_array($_SESSION['old_input']['unitType']) AND in_array($type->id_unite,$_SESSION['old_input']['unitType']))OR(!isset($_SESSION['old_input']['unitType']) AND is_array($item->allowed_units) AND in_array($type->id_unite,$item->allowed_units))):?> checked<?php endif;?>>
							...
							<div class='row'>
								<div class='col-12 mb-3'>
									...
									<div class="input-group">
										<input class='form-control<?php if(isset($_SESSION['errors']['weight'])):?> is-invalid<?php endif ?>' type='number' min='0' step='0.1' name='weight' id='weight' value='<?= $_SESSION['old_input']['weight'] ?? $item->poids_objet?>'>
								...
								<div class='col-12 mb-3'>
									...
									<div class="input-group">
										<input class='form-control<?php if(isset($_SESSION['errors']['price'])):?> is-invalid<?php endif ?>' type='number' min='0' name='price' id='price' value='<?= $_SESSION['old_input']['price'] ?? $item->coutOr_objet?>'>
								...
								<div class='col-12 mb-3'>
									...
									<div class="input-group">
										<input class='form-control<?php if(isset($_SESSION['errors']['cost_PA'])):?> is-invalid<?php endif ?>' type='number' min='0' name='cost_PA' id='cost_PA' value='<?= $_SESSION['old_input']['cost_PA'] ?? $item->coutPa_objet?>'>
								...
								<div class='col-12 mb-3'>
									...
									<div class="input-group">
										<input class='form-control<?php if(isset($_SESSION['errors']['range'])):?> is-invalid<?php endif ?>' type='number' min='0' name='range' id='range' value='<?= $_SESSION['old_input']['range'] ?? $item->portee_objet?>'>
								...
								<div class='col-12 mb-3'>
									...
									<div class="input-group">
										<input class='form-control<?php if(isset($_SESSION['errors']['loss_chance'])):?> is-invalid<?php endif ?>' type='number' min='0' max='100' name='loss_chance' id='loss_chance' value='<?= $_SESSION['old_input']['loss_chance'] ?? $item->Perte_Proba?>'>
							...
							<div class='row'>
								<div class='col-12 mb-3'>
									<div class="form-check form-switch">
										<input class="form-check-input<?php if(isset($_SESSION['errors']['alcohol'])):?> is-invalid<?php endif ?>" type="checkbox" role="switch" id="alcohol" name='alcohol'<?php if((isset($_SESSION['old_input']['alcohol']) AND $_SESSION['old_input']['alcohol']=='on') OR (!isset($_SESSION['old_input']) AND $item->contient_alcool==1)):?> checked<?php endif;?>>
								...
								<div class='col-12 mb-3'>
									<div class="form-check form-switch">
										<input class="form-check-input<?php if(isset($_SESSION['errors']['exchangeable'])):?> is-invalid<?php endif ?>" type="checkbox" role="switch" id="exchangeable" name='exchangeable'<?php if((isset($_SESSION['old_input']['exchangeable']) AND $_SESSION['old_input']['exchangeable']=='on')OR(!isset($_SESSION['old_input']) AND $item->echangeable==1)):?> checked<?php endif;?>>
								...
								<div class='col-12 mb-3'>
									<div class="form-check form-switch">
										<input class="form-check-input<?php if(isset($_SESSION['errors']['droppable'])):?> is-invalid<?php endif ?>" type="checkbox" role="switch" id="droppable" name='droppable'<?php if((isset($_SESSION['old_input']['droppable']) AND $_SESSION['old_input']['droppable']=='on')OR(!isset($_SESSION['old_input']) AND $item->deposable==1)):?> checked<?php endif;?>>
								...
								<div class='col-12 mb-3'>
									<div class="form-check form-switch">
										<input class="form-check-input<?php if(isset($_SESSION['errors']['buyable'])):?> is-invalid<?php endif ?>" type="checkbox" role="switch" id="buyable" name='buyable'<?php if((isset($_SESSION['old_input']['buyable']) AND $_SESSION['old_input']['buyable']=='on')OR(!isset($_SESSION['old_input']) AND $item->achetable==1)):?> checked<?php endif;?>>
								...
								<?php if(isset($camps) && !empty($camps)): ?>
									...
									<div class="form-check form-check-inline mb-2">
										<input class="form-check-input" type="radio" name="spot" id='spot0' value='0'<?php if((isset($_SESSION['old_input']['spot']) AND $_SESSION['old_input']['spot']=='0')OR(!isset($_SESSION['old_input']) AND $item->pastille==0)):?> checked<?php endif;?>>
									...
									<div class="form-check form-check-inline mb-2">
										<input class="form-check-input" type="radio" name="spot" id='spot<?= $camp->id ?>' value='<?= $camp->id ?>'<?php if((isset($_SESSION['old_input']['spot']) AND $_SESSION['old_input']['spot']==$camp->id)OR(!isset($_SESSION['old_input']) AND $item->pastille==$camp->id)):?> checked<?php endif;?>>
								...
								<?php if(isset($camps) && !empty($camps)): ?>
									...
									<?php foreach($camps as $camp): ?>
									<div class="form-check form-check-inline mb-2">
										<input class="form-check-input" type="checkbox" name="camps[]" id='camp<?= $camp->id ?>' value='<?= $camp->id ?>'<?php if((isset($_SESSION['old_input']['camps']) AND is_array($_SESSION['old_input']['camps']) AND in_array($camp->id,$_SESSION['old_input']['camps'])OR(!isset($_SESSION['old_input']['camps']) AND is_array($item->camps) AND in_array($camp->id,$item->camps)))):?> checked<?php endif;?>>
					...
					<div class='row row-cols-1 row-cols-sm-2 row-cols-md-4 mb-3'>
						...
						<div class='mb-3'>
							...
							<div class="input-group">
								<input class='form-control<?php if(isset($_SESSION['errors']['perc'])):?> is-invalid<?php endif ?>' type='number' name='perc' id='perc' value='<?= $_SESSION['old_input']['perc'] ?? $item->bonusPerception_objet?>'>
						...
						<div class='mb-3'>
							...
							<div class="input-group">
								<input class='form-control<?php if(isset($_SESSION['errors']['recup'])):?> is-invalid<?php endif ?>' type='number' name='recup' id='recup' value='<?= $_SESSION['old_input']['recup'] ?? $item->bonusRecup_objet?>'>
								<span class="input-group-text">pt.</span>
							</div>
						...
						<div class='mb-3'>
							...
							<div class="input-group">
								<input class='form-control<?php if(isset($_SESSION['errors']['pv'])):?> is-invalid<?php endif ?>' type='number' name='pv' id='pv' value='<?= $_SESSION['old_input']['pv'] ?? $item->bonusPv_objet?>'>
								<span class="input-group-text">Pt.</span>
							</div>
						...
						<div class='mb-3'>
							...
							<div class="input-group">
								<input class='form-control<?php if(isset($_SESSION['errors']['movement'])):?> is-invalid<?php endif ?>' type='number' name='movement' id='movement' value='<?= $_SESSION['old_input']['movement'] ?? $item->bonusPm_objet?>'>
								<span class="input-group-text">Pt.</span>
							</div>
						...
						<div class='mb-3'>
							...
							<div class="input-group">
								<input class='form-control<?php if(isset($_SESSION['errors']['pa'])):?> is-invalid<?php endif ?>' type='number' name='pa' id='pa' value='<?= $_SESSION['old_input']['pa'] ?? $item->bonusPA_objet?>'>
								<span class="input-group-text">Pt.</span>
							</div>
						...
						<div class='mb-3'>
							...
							<div class="input-group">
								<input class='form-control<?php if(isset($_SESSION['errors']['defense'])):?> is-invalid<?php endif ?>' type='number' name='defense' id='defense' value='<?= $_SESSION['old_input']['defense'] ?? $item->bonusDefense_objet?>'>
								<span class="input-group-text">Pt.</span>
							</div>
						...
						<div class='mb-3'>
							...
							<div class="input-group">
								<input class='form-control<?php if(isset($_SESSION['errors']['prec_cac'])):?> is-invalid<?php endif ?>' type='number' name='prec_cac' id='prec_cac' value='<?= $_SESSION['old_input']['prec_cac'] ?? $item->bonusPrecisionCac_objet?>'>
								<span class="input-group-text">%</span>
							</div>
						...
						<div class='mb-3'>
							...
							<div class="input-group">
								<input class='form-control<?php if(isset($_SESSION['errors']['prec_dist'])):?> is-invalid<?php endif ?>' type='number' name='prec_dist' id='prec_dist' value='<?= $_SESSION['old_input']['prec_dist'] ?? $item->bonusPrecisionDist_objet?>'>
								<span class="input-group-text">%</span>
							</div>
					...
					<div class='row'>
						<div class='col-12 col-sm-3'>
							...
							<img src="../public/img/items/<?= $item->image_objet?>" class="img-fluid" alt="...">
							<div class='mt-2'>
								<label for="imgUpload" class="btn btn-info">Changer d'image</label><br>
							...
							<input class="invisible form-control form-control-sm<?php if(isset($_SESSION['errors']['imgUpload'])):?> text-danger is-invalid<?php endif ?>" id="imgUpload" name="imgUpload" type="file" accept="image/*">
