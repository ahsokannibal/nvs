				...
				<div class="col-12" align="center">
					<div id="table_contraintes" class="table-responsive">
						<table border='1'>
							...
							<tr>
								<td>Hôpital</td><td align='center'>3 + 1 soigneur</td><td align='center'>10</td><td>plus de 20 cases d'une gare ou d'un autre lieu de rapatriement. 2 cases d'un autre batiment. Moins de 40 cases d'une gare ou d'un autre lieu de rapatriement. Plus de 30 cases d'un autre hôpital. 4 hopitaux au maximum par camp</td>
							</tr>
							<tr>
							...
							<tr>
								<td>Ponts</td><td align='center'>0</td><td align='center'> - </td><td>plus de 3 cases d'un autre batiment. 20 cases d'un autre pont. La construction doit démarrer de la terre ferme (pas de pont flottant). Les ponts ne peuvent pas faire plus de 2 cases de largeur.</td>
							</tr>
							<tr>
