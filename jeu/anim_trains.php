...
if($dispo || $admin){
	...
	if (isset($_SESSION["id_perso"])) {
		...
		if (anim_perso($mysqli, $id)) {
			...
			if (isset($_GET['creer_train_liaison']) && $_GET['creer_train_liaison'] != "") {
						...
						<div id="table_batiment" class="table-responsive">						
							<table border="1">
								...
								while ($t = $res->fetch_assoc()) {
									...
									echo "	</td>";
									echo "	<td><img src='../images_perso/b11b.png' width='40' height='40' />Gare ".$nom_gare1." [<a href='evenement.php?infoid=".$id_gare1."'>".$id_gare1."</a>]</td>";
									echo "	<td><img src='../images_perso/b11b.png' width='40' height='40' />Gare ".$nom_gare2." [<a href='evenement.php?infoid=".$id_gare2."'>".$id_gare2."</a>]</td>";
									echo "	<td>";
									if ($id_train != NULL && $id_train != 0) {
