				...
				<div class="col-12">
					<div align="center">
						...
						if (!isset($_GET['top_all'])) {
							echo "<a href='anim_top_logs_acces.php?top_all=ok' class='btn btn-secondary'>Top global</a> ";
						}
						if (!isset($_GET['top_jour'])) {
							echo "<a href='anim_top_logs_acces.php?top_jour=ok' class='btn btn-warning'>Top par jour</a> ";
						}
						if (!isset($_GET['top_mois'])) {
							echo "<a href='anim_top_logs_acces.php?top_mois=ok' class='btn btn-warning'>Top par mois</a> ";
						}
						if (!isset($_GET['top_annee'])) {
							echo "<a href='anim_top_logs_acces.php?top_annee=ok' class='btn btn-warning'>Top par année</a> ";
						}
						echo "<br /><br />";
						?>
						...
						<div id="table_top_logs_acces" class="table-responsive">
							...
							if (isset($_GET['top_jour']) || isset($_GET['top_mois']) || isset($_GET['top_annee']) || isset($_GET['top_all'])) {
								...
								echo "<tr>";
								echo "	<td align='center' colspan='5'><font color='red'><b>Veuillez choisir un TOP</b></font></td>";
								echo "</tr>";
							}
